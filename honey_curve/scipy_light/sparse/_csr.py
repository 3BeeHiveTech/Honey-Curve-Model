...
from ._sparsetools import csr_count_blocks, csr_tobsr, csr_tocsc, get_csr_submatrix
...
class _csr_base(_cs_matrix):
    ...
    def _get_intXslice(self, row, col):
        ...
        return self.__class__(
            (row_data, row_indices, row_indptr), shape=shape, dtype=self.dtype, copy=False
        )
